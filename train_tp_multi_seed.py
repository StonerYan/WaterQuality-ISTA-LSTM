...
# -*- coding: utf-8 -*-
"""
ISTA-LSTM Model Training for TP Parameter
...
from ista_lstm_tp import run_remote_sensing_test

def run_multi_seed_experiment():
    """
    Run multi-seed experiments for TP parameter estimation
    ...
    main_output_dir = Path('../../results/tp_multi_seed')
    ...
    for i, seed in enumerate(seeds, 1):
        ...
        import ista_lstm_tp
        ista_lstm_tp.RANDOM_SEED = seed
        ista_lstm_tp.OUTPUT_DIR = f'ista_lstm_results_tp_{seed}'
