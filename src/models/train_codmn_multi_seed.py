...
# -*- coding: utf-8 -*-
"""
ISTA-LSTM Model Training for CODMn Parameter
...
def run_multi_seed_experiment():
    """
    Run multi-seed experiments for CODMn parameter estimation
    ...
    main_output_dir = Path('../../results/codmn_multi_seed')
    ...
    for i, seed in enumerate(seeds, 1):
        ...
        import ista_lstm_codmn
        ista_lstm_codmn.RANDOM_SEED = seed
        ista_lstm_codmn.OUTPUT_DIR = f'ista_lstm_results_codmn_{seed}'
        
        try:
            # Run experiment
            results = run_remote_sensing_test(
                split_method='station',
